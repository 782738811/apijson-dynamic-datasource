...
@RestController
@RequestMapping("")
@Api(tags = "apijson-dynamic-datasource")
public class DemoController extends APIJSONController<Long> {
     ...
     * @return
     */
    @ApiOperation(value = "增删改查统一接口", httpMethod = "POST", notes = "增删改查统一接口")
    ...
    @ApiOperation(value = "增删改查统一接口,crudByTag", httpMethod = "POST", notes = "增删改查统一接口,crudByTag")
